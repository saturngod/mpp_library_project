...
import business.usecases.AddBookUseCase;
import business.usecases.GetAuthorUseCase;
import business.usecases.SearchBookUseCase;
...
public class BookWindow extends JFrame implements LibWindow {
	...
	private AddBookUseCase addBookUseCase = ControllerFactory.getController(ControllerType.Book);
	private SearchBookUseCase searchBookUseCase = ControllerFactory.getController(ControllerType.Book);
	...
	public void init() {
		...
		mainPanel.setBounds(0, 0, 800, 720);
	...
	public List<Author> getAllAuthors() {
		GetAuthorUseCase ac = ControllerFactory.getController(ControllerType.Author);
